...
import wtf.opal.client.renderer.liquidglass.reglass.gui.LiquidGlassGuiElementRenderState;
import wtf.opal.mixin.reglass.GuiRenderStateAccessor;
...
public final class LiquidGlassUniforms {
    ...
    private LiquidGlassUniforms() {
        samplerInfo = RenderSystem.getDevice().createBuffer(() -> "opal liquid glass SamplerInfo", 130, 16);
        ...
        customUniforms = RenderSystem.getDevice().createBuffer(() -> "opal liquid glass CustomUniforms", 130, customUniformsSize);

        int widgetInfoSize = 16 + MAX_WIDGETS * (16 * 12);
        widgetInfo = RenderSystem.getDevice().createBuffer(() -> "opal liquid glass WidgetInfo", 130, widgetInfoSize);
        ...
        bgConfig = RenderSystem.getDevice().createBuffer(() -> "opal liquid glass BgConfig", 130, bgConfigSize);
    }
    ...
    public void tryApplyBlur(DrawContext context) {
        ...
        int blurLayer = ((GuiRenderStateAccessor) state).opal$getBlurLayer();
    ...
    public void addWidget(LiquidGlassGuiElementRenderState element) {
        ...
        if (!loggedWidget) {
            loggedWidget = true;
            LOGGER.info("OpenOpal ReGlass collected widget ({}, {})-({}, {}), radius={}, scale={}",
    ...
    public void logCompositeOnce() {
        ...
        MinecraftClient mc = MinecraftClient.getInstance();
        LOGGER.info("OpenOpal ReGlass composite: widgets={}, framebuffer={}x{}",
