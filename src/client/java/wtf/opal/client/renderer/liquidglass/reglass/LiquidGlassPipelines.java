    ...
    public static synchronized RenderPipeline getGuiPipeline() {
        if (LIQUID_GLASS_GUI == null) {
            RenderPipeline.Builder b = RenderPipeline.builder()
                    .withLocation(Identifier.of("opal", "pipeline/liquid_glass_gui"))
                    .withVertexShader(Identifier.of("opal", "core/liquid_glass_fullscreen"))
                    .withFragmentShader(Identifier.of("opal", "program/liquid_glass_gui"))
